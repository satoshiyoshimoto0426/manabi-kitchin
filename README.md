...
ManabiOps のドキュメントは **2種類** を用意しています。
役割と目的に合わせて、適切な方を読んでください。

| 対象 | ドキュメント | 内容 |
|------|------------|------|
| 👩 **仲間・ボランティア・保護者** | **[📖 機能説明書](./docs/features/README.md)** | 「何ができるの?」「どう使うの?」をIT用語なしで説明 |
| 🔧 **運営代表・システム担当者** | **[🛠 セットアップガイド](./docs/setup-guide/README.md)** | 本番APIに接続する完全手順 (00〜14章) |

### 👉 おすすめの読み順

- **新ボランティアさんが参加**: [機能説明書 01_概要](./docs/features/01_これは何_ManabiOps概要.md)
- **保護者に説明したい**: [機能説明書 08_安心・安全](./docs/features/08_安心・安全への配慮.md)
- **助成金申請をしたい**: [機能説明書 09_費用と運用体制](./docs/features/09_費用と運用体制.md)
- **本番稼働させたい**: [セットアップガイド 00_概要](./docs/setup-guide/00_overview.md)
